            ...
            if event.button == 1:  # Bouton gauche de la souris
                if play_button_rect.collidepoint(event.pos):
                    ...
                    while not QuitCredit:
                        ...
                        ManageScreen.displayOnScreen(menu, "Luc Martrenchar", 435, 275, (63,72,204), 45)
                        ManageScreen.displayOnScreen(menu, "Roch Triomphe", 435, 350, (63,72,204), 45)
                        ManageScreen.displayOnScreen(menu, "Mélia Tanguy", 435, 425, (63,72,204), 45)
                        ManageScreen.displayOnScreen(menu, "Alban Sulpice", 435, 500, (63,72,204), 45)
                        ManageScreen.leave()
                        pygame.display.update()
